...
var PersonalitySunburstChart = function (_PersonalitySunburstC) {
  ...
  function PersonalitySunburstChart(options) {
    ...
    var _options = Object.assign({}, DEFAULT_OPTIONS, pick(options, ['element', 'selector', 'locale', 'colors', 'exclude']));
    return _possibleConstructorReturn(this, (PersonalitySunburstChart.__proto__ || Object.getPrototypeOf(PersonalitySunburstChart)).call(this, _options, D3PersonalityProfileV2, ChartRendererV4, PersonalityTraitNamesV2));
  }
