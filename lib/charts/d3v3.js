...
var PersonalitySunburstChart = function (_PersonalitySunburstC) {
  ...
  function PersonalitySunburstChart(options) {
    ...
    var _options = Object.assign({}, DEFAULT_OPTIONS, pick(options, ['element', 'selector', 'version', 'locale', 'colors', 'exclude']));
    return _possibleConstructorReturn(this, (PersonalitySunburstChart.__proto__ || Object.getPrototypeOf(PersonalitySunburstChart)).call(this, _options, _options.version === 'v2' ? D3PersonalityProfileV2 : D3PersonalityProfileV3, ChartRendererV3, _options.version === 'v2' ? PersonalityTraitNamesV2 : PersonalityTraitNamesV3));
  }
